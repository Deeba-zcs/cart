...
import { updateQuantity, removeItem } from "src/app/Store/registerslice.js";
...
function Cartpage() {
  ...
  const handleRemoveItem = (item) => {
    ...
    // Remove the item from the local state and local storage
    const updatedCartItems = userCartItems.filter(
                  ...
                  <div className="col-3">
                    <div className="col-3">
                      ...
                      <a
                        className="mx-2"
                        href="#"
                        onClick={() => handleIncreaseQuantity(item, subitem)}
                      >
                        +
                      </a>
                      <a
                        className="mx-2"
                        href="#"
                        onClick={() => handleDecreaseQuantity(item, subitem)}
                      >
                        -
                      </a>
                    </div>
